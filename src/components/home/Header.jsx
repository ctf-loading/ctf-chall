...
const Header = () => {
    ...
    const templateInfo = {
        from_name: name,
        from_email:mail,
        hmmmmmmmm_ : import.meta.env.VITE_APP_VIT,
        client_email : email,
...
{/*        <div className="flex justify-center   ">
            <button className='fixed bg-green-600 font-bold '>back to top</button>
        ...
        <div className=" h-10 w-10 rounded-xl bg-gradient-to-r from-gray-500 to-gray-100 flex items-center justify-center text-green-600 font-bold text-xl mr-3">
             <img className="object-cover" src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Ftse4.mm.bing.net%2Fth%3Fid%3DOIP.8ziBpZH__PNzzfBXOss4lwAAAA%26pid%3DApi&f=1&ipt=66afdbad5a8417bc360e6c26dd6b0e13498e1691ef59bdb33b5aaa794d640359&ipo=images"/>
        </div>
        <span className=" text-xl font-bold bg-gradient-to-r from-gray-300 to-gray-100 bg-clip-text text-transparent">
           <a href="#" className="text-green-500">Bombordilo</a>
        </span>
        </motion.div>
        ...
        <a 
                ...
                className="relative text-gray-200 text-green-500 font-semibold transition-colors duration-300 group"
                 href="#home">Home
            ...
            {["Skills","About","Contact"].map((item,index) => (
                ...
                className="relative text-gray-200 hover:text-green-500 font-semibold transition-colors duration-300 group"
        ...
        <div className="md:flex hidden items-center space-x-4">
            ...
            href="https://github.com/" target="_blank" className="text-gray-300 hover:text-green-400 transition-colors duration-300">
            ...
            animate={{opacity:1 ,scale:1}}
            transition={{delay:1.3 ,duration:0.8}}
            href="https://x.com/" target="_blank" className="text-gray-300 hover:text-green-400 transition-colors duration-300">
            ...
            animate={{opacity:1 ,scale:1}}
            transition={{delay:1.3 ,duration:0.8}}
            href="#" className="text-gray-300 hover:text-green-400 transition-colors duration-300">
            ...
            stiffness:100,
            damping:15,}}
            className="ml-4 px-4 py-2 rounded-xl bg-gradient-to-r from-gray-400 to-gray-100 text-green-700 font-bold hover:from-green-700 hover:to-purple-700 hover:text-white transition-all duration-500 "
            >Contact Me
        ...
        <div className="pt-4 border-tborder-gray-700">
            ...
            bg-gradient-to-r from-green-600 to-violet-400 font-bold">Contact Me</button>
        </div>
            ...
            duration: 0.8}}
             ...
             >
                <div className="flex justify-between items-center mb-4">
                    ...
                    <FiX  className="w-5 h-5  text-gray-300 font-extrabold hover:text-green-600 border rounded-2xl  hover:border-amber-100 transition duration-300 cursor-pointer"/>
                    </button>
                </div>
                ...
                whileTap={{scale : 0.97}}                
                className="w-full px-4 py-2 bg-gradient-to-r from-green-600
                 to-violet-400 hover:from-green-700 hover:to-green-700 
