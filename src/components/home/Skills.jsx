...
const Skills = () => {
  return (
    <section className="bg-black py-16 px-6 lg:px-24">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-8">
          {skillsData.map(({ name, img }) => (
            <motion.div
              ...
              className="flex flex-col items-center bg-gradient-to-r from-green-700 to-black rounded-2xl p-6 shadow-lg
              border border-white transition-colors duration-300 hover:from-green-700 hover:to-purple-700"
            >
              <img
                src={img}
                alt={name}
      ...
      <footer className="bg-green-700 rounded-lg shadow-sm mt-16 py-6">
