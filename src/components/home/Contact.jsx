...
const Contact = () => {
        ...
        let x = import.meta.env.VITE_APP_FLAG
    ...
    >
      ...
      <form className="space-y-4 text-sm" onSubmit={handle_submit}>
        <div>
          ...
          <input
            className="w-full px-3 py-2 border border-gray-600 rounded-lg focus:ring-2 focus:ring-green-500 bg-gray-800 text-white"
            type="text"
            id="name"
            value={name}
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.97 }}
          className="w-full px-4 py-2 bg-gradient-to-r from-green-600 to-violet-500 hover:from-green-700 hover:to-green-600 transition-all duration-300 rounded-lg shadow-md hover:shadow-violet-600/50 text-white font-semibold text-sm"
        >
          Send Message
        </motion.button>
      </form>
